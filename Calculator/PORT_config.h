...
/***********************************************************************************/
/*0 -> floating if input ,low if output
  1 -> pulled up if input ,high if output*/
#define PORTA_PIN0_INIT 	1
#define PORTA_PIN1_INIT 	1
#define PORTA_PIN2_INIT		1
#define PORTA_PIN3_INIT		1
#define PORTA_PIN4_INIT		1
#define PORTA_PIN5_INIT		1
#define PORTA_PIN6_INIT		1
#define PORTA_PIN7_INIT		1



#define PORTB_PIN0_INIT 	1
#define PORTB_PIN1_INIT 	1
#define PORTB_PIN2_INIT		1
#define PORTB_PIN3_INIT		1
#define PORTB_PIN4_INIT		1
#define PORTB_PIN5_INIT		1
#define PORTB_PIN6_INIT		1
#define PORTB_PIN7_INIT		1
